...
[`plan.md`](./plan.md). MVP, REST API, веб-дашборд и второй (не-SDMX)
источник готовы. Росстат/ЕМИСС осознанно отложены (см. выше). Дальше:
отдельное чат-приложение поверх тех же MCP-инструментов.
